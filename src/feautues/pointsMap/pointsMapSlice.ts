...
export const fetchPointsMap = createAsyncThunk(
    ...
    async () => {
        try {
            const response = await fetch('https://gist.githubusercontent.com/JohnGeorgiadis/09c588e60c7d9ef1185547c9c031b694/raw/3a9ef99cbaa82b4bbe4ffb9072fe7b840a5fe424/KahootPoints.json');
            if (!response.ok) {
